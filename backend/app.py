...
class Config:
    ...
    # Lokasi Default (Semarang)
    DEFAULT_LAT = -6.9667
    DEFAULT_LON = 110.4167
    
    # Database (Catatan: Di Vercel Free Tier, data SQLite akan reset setiap redeploy)
    DB_NAME = "/tmp/ecolens.db" if os.environ.get("VERCEL") else "ecolens.db"
